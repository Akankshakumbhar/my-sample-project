...
public class CheckBill extends JFrame implements ActionListener
{
    ...
    CheckBill()
    {
       ...
       // bt3.setBackground(Color.YELLOW);
        ...
        ImageIcon ic=new ImageIcon(ClassLoader.getSystemResource("Cab_Booking/Icons2/splash2.jpg"));
        Image img=ic.getImage().getScaledInstance(700,300,Image.SCALE_DEFAULT);
