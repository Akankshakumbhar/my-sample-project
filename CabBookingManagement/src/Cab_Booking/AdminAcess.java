...
public class AdminAcess extends JFrame implements ActionListener

{
    ...
    AdminAcess()
    {
        ...
        JMenu men4=new JMenu("View Booked Cab");
        ...
        JMenu men9=new JMenu("driver");
        JMenuItem ment15=new JMenuItem("Add Driver Details");
        JMenuItem ment16=new JMenuItem("View Driver Details");
    ...
    public void actionPerformed(ActionEvent e)
    {
    	...
    	else if(comnd.equals("Add Driver Details"))
    	{
    		new Add_Intercity_Driver().setVisible(true);
    	   
    	}
    	else if(comnd.equals("View Driver Details"))
    	{
