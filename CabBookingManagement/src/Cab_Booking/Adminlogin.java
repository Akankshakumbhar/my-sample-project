...
public class Adminlogin extends JFrame implements ActionListener
{
	...
	Adminlogin()
	{
		...
		ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Cab_Booking/Icons/login.jpg"));
		Image i1=img.getImage().getScaledInstance(580,380,Image.SCALE_DEFAULT);
	...
	public void actionPerformed(ActionEvent ee)
	{
		if(ee.getSource()==b1)
		{
			try
			{
				...
				String q="select* from adminsignup where username='"+name+"'and password='"+pass+"'";
