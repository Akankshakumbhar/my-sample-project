...
public class Delete_Customer extends JFrame implements ActionListener
{
    ...
    Delete_Customer()
    {
       ...
       ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Cab_Booking/Icons2/DeleteCustomer.jpg"));
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==bt1)
        {
           ...
           try
           {
               ...
               String q3="delete from interacitycab where username='"+username+"'";
               int aa=obj3.stm.executeUpdate(q);
               if(aa==1)
               {
                   JOptionPane.showMessageDialog(null,"your record sucessfully Deleted");
               ...
               {
                   JOptionPane.showMessageDialog(null,"Please! check all details sucessfully");
