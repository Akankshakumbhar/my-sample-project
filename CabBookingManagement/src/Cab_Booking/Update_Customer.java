...
public class Update_Customer extends JFrame implements ActionListener
{
    ...
    Update_Customer()
    {
     ...
     //   l1.setHorizontalAlignment(JLabel.CENTER);
        ...
        Image img=ic.getImage().getScaledInstance(500,800,Image.SCALE_DEFAULT);
        	...
        	public void mouseClicked(MouseEvent arg0)
        {
            try
            {
                ...
                tf9.setText(rest1.getString("adhar"));
                }
            }
            catch(Exception exx)
            {
   ...
   public void actionPerformed(ActionEvent e)
     {
         if(e.getSource()==bt1)
         {
             ...
             String adhar=tf9.getText();
             try
             {
                 ConnectionClass obj3=new ConnectionClass();
                 String q1="update customer set name='"+name+"',age='"+age+"',dob='"+dob+"',address='"+address+"',phone='"+phone+"',email='"+email+"',country='"+country+"',gender='"+gender+"',adhar='"+adhar+"'where username='"+username+"'";
                 ...
                 {
                      JOptionPane.showMessageDialog(null,"Please,fill your details succcessfully!!");
                 }
             }
             catch(Exception ee)
             {
